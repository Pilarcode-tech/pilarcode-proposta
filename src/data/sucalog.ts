export const sucalog = {
  ...
  contexto: {
    ...
    paragrafos: [
      ...
      "O Sucalog Hub não automatiza só tarefas repetitivas. Ele substitui a memória institucional que hoje está na cabeça de uma pessoa. Tudo que depende de alguém lembrar, cobrar ou notar na correria passa a ser controlado pelo sistema: regra aplicada, alerta disparado, prazo monitorado.",
    ],
  },
  ...
  proposta: {
    ...
    texto1:
      "Propomos o desenvolvimento do Sucalog Hub, um sistema web sob medida que centraliza em um único lugar o que hoje está distribuído entre seis ferramentas e dezenas de planilhas. O sistema cobre todas as empresas do grupo, automatiza os cálculos de fechamento, integra diretamente com Flash, Pluxee, Domínio e Sagi via API, monitora automaticamente as CCTs de cada sindicato e entrega à diretoria um painel de auditoria trabalhista em tempo real.",
    texto2:
  ...
  fases: [
    ...
    },
    {
      ...
      itens: [
        ...
        "Operadoras de saúde e odonto (Amil, Notre Dame, Porto Seguro, Bradesco, EXCard): custo consolidado por empresa, controle de inclusões e movimentações mensais via importação do relatório das operadoras",
    ...
    },
    {
      ...
      itens: [
        ...
        "Notificação automática para o RH após aprovação no Gupy para continuar a admissão",
        "Fluxo de alteração salarial: solicitação pelo gestor, aprovação da diretoria, registro automático",
        "Geração de documentos integrada a plataforma de assinatura digital (ex.: ZapSign, Clicksign, D4Sign): termos de desconto, confissão de dívida, contratos de treinamento, com dados puxados do cadastro. A licença da plataforma de assinatura é contratada separadamente pelo cliente",
        "Comunicação automática para portaria, TI, Almoxarifado, Segurança do Trabalho e refeitório em admissões e rescisões",
        "Alerta automático para o RH sobre colaboradores em aviso prévio com documentação pendente",
      ],
      incluida: false,
    },
    {
