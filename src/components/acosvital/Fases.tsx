    ...
    <section className="px-6 md:px-10 py-10 md:py-14">
      <div className="max-w-4xl mx-auto">
        <SectionHeader
          ...
          description={acosvital.metodologiaDescricao}
        />

        <div className="space-y-5">
          {acosvital.fases.map((f) => (
            <div
              key={f.numero}
              className="bg-bg-light border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-2">
                    ...
                    <span className="font-manrope text-[11px] font-bold text-gray-700 bg-white border border-gray-200 px-3 py-1 rounded-full">
                      {f.duracao}
                    </span>
                  </div>
